...
Naprawiono potwierdzanie trwałego zapisu, odzyskiwanie formatowania szkiców,
pamięć offline oraz import PDF/DOCX i OCR. Szczegóły aktualizacji i używania
importu znajdują się w [instrukcji](docs/WYDANIE.md).
...
Katalog `lib/smart-import/` umożliwia lokalne rozpoznawanie PDF-ów, dokumentów
Word i zrzutów ekranu. Nie należy wybierać pojedynczych plików z tego katalogu —
na GitHub trzeba wgrać go w całości.
